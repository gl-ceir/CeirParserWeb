...
//
//    static Logger logger = LogManager.getLogger(DeleteFromBlackList.class);
...
//        String raw_query = "delete  from BLACKLIST_IMEI_DB   where CREATED_ON <  ( current_timestamp  - ( select value  from sys_param where tag = 'GSMA_BL_MAX_RETENTION_PERIOD_DAYS_IN_DB'  )   ) ";
//        try {
